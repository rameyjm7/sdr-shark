...
const App = () => {
  const [settings, setSettings] = useState({
    ...
    rfModelClassifierRepoPath: '~/workspace/rf-signal-intelligence-private',
    rfModelClassifierModelPath: '~/workspace/rf-signal-intelligence-private/models/noisy_drone_rf_v2/noisy_drone_rf_v2_vgg_full_complex_spectrogram_best.keras',
    rfModelClassifierBackend: 'auto',
    rfModelClassifierEnginePath: '~/workspace/rf-signal-intelligence-private/models/noisy_drone_rf_v2/noisy_drone_rf_v2_vgg_full_complex_spectrogram_fp16.engine',
