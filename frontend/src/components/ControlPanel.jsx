  ...
  const fetchSettings = async ({ refreshDevices = false } = {}) => {
    try {
      ...
      const sanitized = {
        ...
        rfModelClassifierRepoPath: data.rfModelClassifierRepoPath || '~/workspace/rf-signal-intelligence-private',
        rfModelClassifierModelPath: data.rfModelClassifierModelPath || '~/workspace/rf-signal-intelligence-private/models/noisy_drone_rf_v2/noisy_drone_rf_v2_vgg_full_complex_spectrogram_best.keras',
        rfModelClassifierBackend: data.rfModelClassifierBackend || 'auto',
        rfModelClassifierEnginePath: data.rfModelClassifierEnginePath || '~/workspace/rf-signal-intelligence-private/models/noisy_drone_rf_v2/noisy_drone_rf_v2_vgg_full_complex_spectrogram_fp16.engine',
